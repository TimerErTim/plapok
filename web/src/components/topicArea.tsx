...
export default function TopicArea({ topic, isReadOnly }: { topic: string, isReadOnly: boolean }) {
    ...
    return <TextArea value={localTopic ?? topic} onChange={handleTopicChange} readOnly={isReadOnly} fullWidth={true} className={cn("!h-auto", isReadOnly && "!bg-transparent")} inert={isReadOnly} />
}